...
{{--                                    </div>--}}
                                    ...
                                    @if($product->has_image)
                                        ...
                                        <div class="col-md-4">
                                            <img src="{{ asset('images/'.$picture->src)}}" alt="not" style="height:auto; width:100%"/>
                                        </div>
                                        @endforeach
                                    @endif
                                                ...
                                                <td>
                                                    @if(isset($variant->has_image))
                                                        <img class="img-avatar " style="border: 1px solid whitesmoke"  data-input=".varaint_file_input" data-toggle="modal" data-target="#select_image_modal300"
                                                             src="{{ asset('images/'.$variant->has_image->src)}}" alt="not" style="height:120px; width:200px"/>@endif
                                                </td>
