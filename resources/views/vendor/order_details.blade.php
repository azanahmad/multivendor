            ...
            <div class="col-md-9">
                            ...
                            <tr>
                                <td colspan="12" class="text-right">
                                    @if($order->getStatus($order) == "unfulfilled")
                                        <button class="btn btn-primary" onclick="window.location.href='{{route('vendor_fulfill_order',$order->id)}}'"> Mark as Fulfilled </button>
                                    @endif
                                </td>
                            </tr>
                    ...
                    <div class="block-content">
                        <table class="table table-borderless table-vcenter">
                            ...
                            <tr>
                                ...
                                <td align="right">
                                    {{number_format($total - $order->shipping_price,2)}} {{$order->currency}}
                                </td>
                            </tr>
                            <tr>
                                <td>
                ...
                @if(count($order->fulfillments) >0)
                    ...
                    @foreach($order->fulfillments as $fulfillment)
                        @if($fulfillment->vendor_id ==auth()->user()->id)
                        <div class="block">
                            <div class="block-header block-header-default">
                                <h3 class="block-title">
                                    {{$fulfillment->name}}
                            ...
                            <div class="modal-dialog modal-lg modal-dialog-popout" role="document">
                                <div class="modal-content">
                                    <div class="block block-themed block-transparent mb-0">
                                        ...
                                        <form action="{{route('vendor.order.fulfillment.tracking',$order->id)}}" method="post">
                                            @csrf
                                            <div class="block-content">
