                ...
                <div class="block">
                    ...
                    <div class="block-content">
                        ...
                        <table class="table table-borderless table-striped table-vcenter">
                            ...
                            <tbody>
                            <form id="fulfilment_process_form" action="{{route('vendor.order.fulfillment.process',$order->id)}}" method="post">
                                @csrf
                                            ...
                                            <td>
                                                @if($item->linked_variant != null)
                                                    <img class="img-avatar"
                                                         ...
                                                         @else src="{{asset('images/')}}/{{$item->linked_variant->has_image->src}}" @endif alt="">
                                                @else
            ...
            <div class="col-md-4">
                ...
                <div class="block">
                    ...
                    <div class="block-content">
                        ...
                        <div class="row mb2">
                            <div class="col-md-12">
                                <button class="btn fulfill_items_btn btn-block btn-primary" type="submit"> Fulfill Items</button>
                            </div>
                        </div>
                    </form>
