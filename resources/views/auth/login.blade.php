                            ...
                            <div class="block block-themed block-fx-shadow mb-0">
                                <div class="block-header">
                                    ...
                                    <div class="block-options">
                                        <a class="btn-block-option font-size-sm" href="{{url('/forget_password')}}">Forgot Password?</a>
                                        <a class="btn-block-option" href="{{url('/register')}}" data-toggle="tooltip" data-placement="left" title="New Account">
                                        ...
                                        <form class="js-validation-signin" action="{{ route('login') }} " method="POST">
                                            ...
                                            <div class="py-3">
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-alt form-control-lg @error('email') is-invalid @enderror" id="login-username" name="email" placeholder="Email">
                                                    @error('email')
